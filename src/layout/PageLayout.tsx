...
import BaseSider from '@/layout/components/Base/BaseSider'
import BaseHeader from '@/layout/components/Base/BaseHeader'
import GlobalDraw from '@/components/GlobalDraw'
import { useSettingStore, useTagsViewStore } from '@/store'
import AppMain from '@/layout/components/Base/AppMain'
